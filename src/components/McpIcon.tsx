...
/** MCP logo: https://commons.wikimedia.org/wiki/File:Model_Context_Protocol_logo.svg */
export function McpIcon({ size = 16, ...props }: SVGProps<SVGSVGElement> & { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 180 180" fill="none" aria-hidden={props["aria-label"] ? undefined : true} {...props}>
